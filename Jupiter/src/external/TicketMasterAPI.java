...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "TsUOXzJA9t0AL6HgGjw93RXdSV6cjUei";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			//Convert the JSON format and get the we care about
		...
		if (!event.isNull(IMAGES)) {
			...
			for (int i = 0; i < images.length(); i++) {
				...
				if (!image.isNull(URL_STR)) {
					String urlString = image.getString(URL_STR);
					return urlString;
				}
			} 
		}
